...
/**
 * This is My second ablation experiments
 *
 * @see UtilityListHUPlus
 * @see Element
 * @author Philippe Fournier-Viger
 */
public class AlgoHUPplusMinerSecond {
	...
	* the idea is to always reuse the same buffer to reduce memory usage. */
	...
	public void runAlgorithm(String input, String output, int minUtility, int k) throws IOException {
		...
		for(Integer item: mapItemToTWU.keySet()){
			...
			if(mapItemToTWU.get(item) >= minUtility){
				...
				UtilityListHUPlus uList = new UtilityListHUPlus(item, this.k);
	...
	private UtilityListHUPlus construct(UtilityListHUPlus P, 
		...
		UtilityListHUPlus pxyUL = new UtilityListHUPlus(py.item,k);
	 ...
	 */
	private Element findElementWithTID(UtilityListHUPlus ulist, int tid){
